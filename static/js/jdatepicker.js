...
function jDatePicker(id, options = {headerColor: '#2196f1', bodyColor: '#fff', dariMonth: true}) {
    ...
    dateContainer.innerHTML = `<div style="background: ${options.headerColor || '#2196f1'}; display: flex; justify-content: space-between; align-items: center; padding: 10px 0;">
        <svg id="prev-year${index}" style="height: 36px;background-color: blue; color:255 255 0; padding:20px; cursor:pointer;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
        </svg>
        <h2 id="year-title${index}" style="color: blue !important;"></h2>
        <svg id="next-year${index}" style="height: 36px; color:blue; padding:20px; cursor:pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div style="background: ${options.bodyColor || '#fff'};">
        <div style="display: flex; justify-content: space-around; align-items: center;">
            ...
            <svg id="next-month${index}" style="height: 20px; padding:20px; cursor:pointer" fill="none" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
        </div>
